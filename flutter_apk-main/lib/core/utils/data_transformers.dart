...
class DataTransformers {
    ...
    return {
      ...
      'settings': {
        ...
        'privacy': {
          ...
          'showPhone': user.settings.privacy.showPhone,
        },
      },
      'subscription': {
  ...
  static Map<String, dynamic> prepareAnalyticsData({
    ...
    return {
      'userId': user.id,
      'userMetrics': {
        'accountAge': user.accountAge.inDays,
        'isPremium': user.isPremium,
        'lastLoginDays': user.timeSinceLastLogin.inDays,
      },
      'paymentMetrics': {
      ...
      'deviceMetrics': payment.metadata?.deviceInfo.toJson(),
      'locationMetrics': payment.metadata?.location.toJson(),
      'networkMetrics': payment.metadata?.networkInfo.toJson(),
